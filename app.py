...
#function to load google gemimi model and provide sql query as response
...
prompt = [
    ...
    SECTION and MARKS \n\n For example, \nExample 1 - How many entries of records are presnet?,
    the SQL command will be somthing like this SELECT COUNT(*) FROM STUDENT;
    \nExample 2 - Tell me all the students studying in data science class?,
    the SQL command will be somthing like this SELECT * FROM STUDENT
